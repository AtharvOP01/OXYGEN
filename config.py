...
EVALOP = list(map(int, getenv("EVALOP", "5538690269").split()))
...
LOGGER_ID = int(getenv("LOGGER_ID", -1002049083613))

# ------------------------------------------------
GPT_API = getenv("GPT_API")
# Get this value from  on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID", 5538690269))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/AtharvOP01/OXYGEN",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/premiumxop")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/WHOxCARES_0")
